...
const LinearIcons = {
    ...
    certificate: (
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <rect x="3" y="2" width="18" height="15" rx="2" ry="2"></rect>
            <path d="M9 17v3l3-1 3 1v-3"></path>
            <path d="M8 8h8"></path>
            <path d="M8 12h8"></path>
        </svg>
    ),
    ...
    key: (
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <path d="M10 17h4l3-3-3-3h-4"></path>
            <path d="M14 14l1-1"></path>
        </svg>
    ),
    settings: (
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
// 获取小尺寸的线性图标（12px）
export const getSmallLinearIcon = (iconKey: string): React.ReactElement | null => {
...
// 获取图标前缀的通用函数
export const getIconPrefix = (iconKey?: string): React.ReactElement => {
    if (iconKey) {
